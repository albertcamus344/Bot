# First, let's create the main Telegram bot script for YouTube downloading
bot_code = '''
import os
import asyncio
import logging
...
# Save the bot code
with open('youtube_bot.py', 'w', encoding='utf-8') as f:
    f.write(bot_code)

print("✅ Main bot script created: youtube_bot.py")